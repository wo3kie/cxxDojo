 ...
 *
 * Compilation:
 *      g++ --std=c++17 isDuplicate.cpp -o isDuplicate
 *
 * Usage:
 *      $ ./isDuplicate
 */
...
void duplicate_perf_test_1(){
    ...
    test([&](){isDuplicateS(words.begin(), words.end());}, 3);
    test([&](){isDuplicateU(words.begin(), words.end());}, 3);
    test([&](){isDuplicateT(words.begin(), words.end());}, 3);
}
