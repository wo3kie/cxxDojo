...
std::pair<Iterator, Iterator> _minmax(Iterator begin, Iterator end){
    ...
    std::future<std::pair<Iterator, Iterator>> left_part = std::async(std::launch::async, _minmax<Iterator>, begin, begin+size/2);
    std::future<std::pair<Iterator, Iterator>> right_part = std::async(std::launch::async, _minmax<Iterator>, begin+size/2, end);
