...
struct IteratorTypeErasure: TypeErasureBase, PreIncrementTypeErasure, DereferenceTypeErasure<Value>, EqualTypeErasure {
  template<typename Iterator>
  IteratorTypeErasure(const Iterator& iterator)
      : TypeErasureBase(iterator) {
    PreIncrementTypeErasure::init<Iterator>();
    DereferenceTypeErasure<Value>::template init<Iterator>();
