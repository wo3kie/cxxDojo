...
public:
    ...
    void add(
        std::initializer_list<double> const & list1,
        std::initializer_list<double> const & list2
    ){
    ...
    double getScore() const {
        ...
        double const ss_tot = actual2_sum_ - 2 * actual_avg * actual_sum_
            + count_ * actual_avg * actual_avg;
