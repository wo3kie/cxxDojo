...
inline
Vector operator*(double scalar, Vector const & vector){
...
inline
double dot(Vector const & vector1, Vector const  vector2){
    double result = 0;
...
inline
double norm2(Vector const & vector){
...
inline
Vector projection(Vector const & what, Vector const & where){
